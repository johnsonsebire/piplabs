...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-md bg-[#0f1318] text-[#e2e8f0]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  ...
  >
    <Search className="mr-2 h-4 w-4 shrink-0 text-muted-foreground" style={{ display: 'block' }} />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default gap-2 select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none data-[disabled=true]:pointer-events-none data-[selected=true]:bg-[#10b981]/10 data-[selected=true]:text-[#10b981] data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
      className
    )}
    {...props}
  />
