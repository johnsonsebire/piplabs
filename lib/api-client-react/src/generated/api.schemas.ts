...
export interface TradeInput {
  ...
  mode?: TradeInputMode;
  /**
     * ID of the MT5 account to use for forex trades via MetaApi
     * @nullable
     */
  mt5AccountId?: string | null;
  /**
...
export type MultiTimeframeTrendInputTimeframesData = { [key: string]: unknown };
...
export type MultiTimeframeTrendOutputTimeframesItem = {
  timeframe: string;
  trend: MultiTimeframeTrendOutputTimeframesItemTrend;
  strength: number;
};

export type MultiTimeframeTrendOutputMarketState = typeof MultiTimeframeTrendOutputMarketState[keyof typeof MultiTimeframeTrendOutputMarketState];


export const MultiTimeframeTrendOutputMarketState = {
  RANGING: 'RANGING',
  TRENDING: 'TRENDING',
} as const;
